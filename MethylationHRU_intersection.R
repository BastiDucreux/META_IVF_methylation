...
#selection genes with >=2DMPs to match Katari et al. criteria
...
IGlist <- read.table("imprinted.genes.csv", quote="\"", comment.char="")
...
x=list("Yeung et al. (2021) neonates"=na.omit(unique(YeungDMP$Gene)),"Barberet et al. (2021)"=na.omit(unique(BarberetDMP$Gene)),
       ...
       "Melamed et al. (2014)"=na.omit(unique(MelamedDMP$Gene)),"Katari et al. (2009) cord blood"=na.omit(unique(KatariDMPcord$Gene)),"Katari et al. (2009) placenta"=na.omit(unique(KatariDMPplacenta$Gene)),
       "El Hajj et al. (2017)"=na.omit(unique(ElHajjDMP$Gene)),"Camaraschi et al. (2021)"=na.omit(unique(CamaraschiDMP$Gene)))

x=fromList(x)
names=c("Barberet et al. (2021)","Yeung et al. (2021) neonates","Novakovic et al. (2019) neonates","Camaraschi et al. (2021)","Tobi et al. (2021)","El Hajj et al. (2017)","Melamed et al. (2014)","Katari et al. (2009) cord blood","Katari et al. (2009) placenta")

x2=x[,names]
x_metadata = data.frame(
  set=c("Camaraschi et al. (2021)","Tobi et al. (2021)","Melamed et al. (2014)","Katari et al. (2009) cord blood","El Hajj et al. (2017)","Katari et al. (2009) placenta","Novakovic et al. (2019) neonates","Yeung et al. (2021) neonates","Barberet et al. (2021)"),
...
upset(x2,
      ...
      queries=list(
        ...
        upset_query(intersect='Melamed et al. (2014)', color='azure3',fill='azure3'),
        ...
        upset_query(intersect=c("Barberet et al. (2021)","Katari et al. (2009) cord blood","Melamed et al. (2014)"), color='azure4',fill='azure4'),
      ...
      intersections=list(c("Katari et al. (2009) placenta"),
                         c("Katari et al. (2009) cord blood"),c("Melamed et al. (2014)"), c("El Hajj et al. (2017)"),c("Tobi et al. (2021)"),c("Camaraschi et al. (2021)"),
                         ...
                         c("Barberet et al. (2021)","Katari et al. (2009) cord blood","Melamed et al. (2014)"),
